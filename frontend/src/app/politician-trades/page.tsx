...
export default function PoliticianTradesPage() {
  ...
  const benefits = [
    { icon: Building2, title: 'Full Congress Coverage', desc: 'Every Senator and Representative tracked across both chambers.' },
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl text-gray-400 mb-8">
                ...
                from every member of Congress - sourced directly from STOCK Act filings.
              </p>
        ...
        <div className="container-custom">
          ...
          >
            ...
            <div className="flex items-center justify-center gap-6 mt-8 text-sm text-gray-500">
              ...
              <span className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-primary" /> Every Congress member</span>
            </div>
          </motion.div>
        </div>
      </section>
